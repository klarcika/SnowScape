...
const formatTimeToEuropean = (dateTime: Date): string => {
  const options: Intl.DateTimeFormatOptions = {
    hour: 'numeric',
    minute: '2-digit',
    hour12: false,
    timeZone: 'Europe/Ljubljana', // Set the desired time zone
  };
  return dateTime.toLocaleString('en-GB', options);
};

const getOpenWeatherMapIconUrl = (iconCode: string) => {
...
const renderIcon = (weatherCond: string) => {
...
const WeatherBody: React.FC<WeatherBodyProps> = ({ item }) => {
